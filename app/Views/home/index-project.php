...
<div style="padding: 100px 0;">
        ...
        <div class="col-12 col-md-6 col-lg-4 mx-auto m-0 p-0 d-flex justify-content-center justify-content-lg-start align-items-center">
            <div class="card bg-color3 mb-4 position-relative border-color4" style="width:340px;min-height:280px;margin-top:100px;" data-aos="fade-up" data-aos-easing="ease-in-out-back" data-aos-offset="-80">
                ...
                <div class="card-body d-flex flex-column" style="margin-top:100px;">
                    ...
                    <div class="row m-0 p-0 mt-auto">
                            <div class="col-lg-6 d-flex justify-content-center p-1"><a target="_blank" href="https://akasamimpi.com" class="btn btn-sm btn-color4-outline" style="width:100%;">Show website <i class="fas fa-link ms-1"></i></a></div>
                            <div class="col-lg-6 d-flex justify-content-center p-1"><a target="_blank" href="https://github.com/achmedhibatillah/website-pemenangan" class="btn btn-sm btn-color4-outline" style="width:100%;">Show repository <i class="fab fa-github ms-1"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row m-0 p-0">
        <div class="col-md-4 d-flex justify-content-center justify-content-md-start align-items-center">
            <div class="card mx-4 px-4 m-0 border-color2 d-flex justify-content-center align-items-center position-relative mt-5" style="width:310px;height:320px;background:linear-gradient(to bottom right,var(--color-sec), var(--color-4),var(--color-4), var(--color-4),var(--color-sec));" data-aos="fade-up" data-aos-delay="10" data-aos-easing="ease-in-out-back">
