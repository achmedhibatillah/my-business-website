            ...
            <div class="card bg-color3 mb-4 position-relative" style="width:340px;min-height:280px;margin-top:100px;" data-aos="fade-up" data-aos-easing="ease-in-out-back" data-aos-offset="100">
                ...
                <div class="card-body d-flex flex-column" style="margin-top:100px;">
                    ...
                    <div class="row m-0 p-0 mt-auto">
                            <div class="col-lg-6 d-flex justify-content-center p-1"><a target="_blank" href="https://politik.ub.ac.id" class="btn btn-sm btn-color4" style="width:100%;">Show website <i class="fas fa-link ms-1"></i></a></div>
                            <div class="col-lg-6 d-flex justify-content-center p-1"><a target="_blank" href="https://github.com/achmedhibatillah/website-ilmupolitik-ub" class="btn btn-sm btn-color4" style="width:100%;">Show repository <i class="fab fa-github ms-1"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 m-0 p-0 d-flex justify-content-center align-items-center">
            <div class="card bg-color3 mb-4 position-relative" style="width:340px;min-height:280px;margin-top:100px;" data-aos="fade-up" data-aos-easing="ease-in-out-back" data-aos-offset="100">
                ...
                <div class="card-body d-flex flex-column" style="margin-top:100px;">
                    ...
                    <div class="row m-0 p-0 mt-auto">
                            <div class="col-lg-6 d-flex justify-content-center p-1"><a target="_blank" href="https://wormvillage.com" class="btn btn-sm btn-color4" style="width:100%;">Show website <i class="fas fa-link ms-1"></i></a></div>
                            <div class="col-lg-6 d-flex justify-content-center p-1"><a target="_blank" href="https://github.com/achmedhibatillah/wormvillage" class="btn btn-sm btn-color4" style="width:100%;">Show repository <i class="fab fa-github ms-1"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 m-0 p-0 d-flex justify-content-center align-items-center">
            <div class="card bg-color3 mb-4 position-relative" style="width:340px;min-height:280px;margin-top:100px;" data-aos="fade-up" data-aos-easing="ease-in-out-back" data-aos-offset="100">
                ...
                <div class="card-body d-flex flex-column" style="margin-top:100px;">
                    ...
                    <div class="row m-0 p-0 mt-auto">
                            <div class="col-lg-6 d-flex justify-content-center p-1"><a target="_blank" href="https://akasamimpi.com" class="btn btn-sm btn-color4" style="width:100%;">Show website <i class="fas fa-link ms-1"></i></a></div>
                            <div class="col-lg-6 d-flex justify-content-center p-1"><a target="_blank" href="https://github.com/achmedhibatillah/website-pemenangan" class="btn btn-sm btn-color4" style="width:100%;">Show repository <i class="fab fa-github ms-1"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
